...
```
run_crforest.py         # crforest gen + bench + self-test
...
timings/                # crforest_timings.parquet, rfsrc_timings.parquet
...
uv run python run_crforest.py --step bench       # ~35 min on Apple M4 10-core
